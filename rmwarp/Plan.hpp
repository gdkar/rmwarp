...
struct FFTPlan {
    ...
    { }
    FFTPlan(fftwf_plan _d, r2c_exec* fn, difference_type off_in, difference_type off_out) noexcept
    : m_d{_d}
    , m_r2c{fn}
    , m_off_in{off_in}
    , m_off_out{off_out}
    ...
    FFTPlan(fftwf_plan _d, c2c_exec* fn, difference_type off_in, difference_type off_out   ) noexcept
    : m_d{_d}
    , m_c2c{fn}
    , m_off_in{off_in}
    ,m_off_out{off_out}
   ...
   ~FFTPlan()
    ...
    static FFTPlan dft_1d_r2c(int _n, float_type *_ti, float_type *_ro, float_type *_io)
    {
        ...
        auto _d = fftwf_plan_guru_split_dft_r2c(
            1, &dims, 0, nullptr, _ti, _ro, _ro + off_out, FFTW_MEASURE);
    ...
    static FFTPlan dft_1d_c2r(int _n, float_type *_ri, float_type *_ii, float_type *_to)
    {
        ...
        auto _d = fftwf_plan_guru_split_dft_c2r(
            1, &dims, 0, nullptr, _ri, _ri + off_in, _to, FFTW_MEASURE);
