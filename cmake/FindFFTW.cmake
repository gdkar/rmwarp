...
find_library( FFTW_THREADS_LIBRARIES
    NAMES fftw3f_threads libfftw3f_threads-3
    HINTS
        ${FFTW_ROOT}/lib
        ${FFTW_ROOT}/.libs
        ${FFTW_ROOT}
...
set( FFTW_LIBRARIES ${FFTW_SINGLE_PRECISION_LIBRARIES} ${FFTW_DOUBLE_PRECISION_LIBRARIES} ${FFTW_THREADS_LIBRARIES} )
...
if( NOT FFTW_FOUND )
    message( STATUS "FindFFTW looked for single precision threads libraries named: fftw3f_threads or libfftw3f_threads-3" )
